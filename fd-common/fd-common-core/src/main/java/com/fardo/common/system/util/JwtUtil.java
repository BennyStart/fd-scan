package com.fardo.common.system.util;
...
public class JwtUtil {
	 ...
	 * @throws FdException
	 */
	public static String getUserNameByToken(HttpServletRequest request) throws FdException {
		String accessToken = request.getHeader("X-Access-Token");
		String username = getUsername(accessToken);
		if (oConvertUtils.isEmpty(username)) {
			throw new FdException("未获取到用户");
		}
		return username;
	}
	 ...
	 * @throws FdException
	 */
	public static LoginUser getLoginUser() throws FdException {
...
//			log.warn(" 非request方式访问！! ");
		...
		LoginUser sysUser = (LoginUser) redisUtil.get(CacheConstant.SYS_USERS_CACHE_JWT +":" +accessToken);
		return sysUser;
	}
