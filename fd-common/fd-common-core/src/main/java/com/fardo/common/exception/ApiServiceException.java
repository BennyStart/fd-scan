...
public class ApiServiceException extends IllegalStateException {
	 ...
	 * @param message
	 */
	public ApiServiceException(String status, String message){
		this.status = status;
		this.message = message;
	}

	public ApiServiceException(IResultCode resultCode){
