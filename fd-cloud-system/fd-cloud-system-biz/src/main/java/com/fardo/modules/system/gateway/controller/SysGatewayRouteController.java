package com.fardo.modules.system.gateway.controller;
...
@Slf4j
public class SysGatewayRouteController extends BaseController<SysGatewayRouteEntity, ISysGatewayRouteService> {
	...
	public Result<?> queryPageList(SysGatewayRouteEntity sysGatewayRoute) {
		LambdaQueryWrapper<SysGatewayRouteEntity> query = new LambdaQueryWrapper<>();
		query.eq(SysGatewayRouteEntity::getStatus,1);
		List<SysGatewayRouteEntity> ls = sysGatewayRouteService.list(query);
		JSONArray array = new JSONArray();
		for(SysGatewayRouteEntity rt: ls){
