package com.fardo.modules.system.permission.mapper;
...
public interface SysPermissionMapper extends BaseMapper<SysPermissionEntity> {
	...
	/**
	  *   根据用户查询用户权限
	 */
	public List<SysPermissionEntity> queryByUser(@Param("username") String username);
	 ...
	 * @return
	 */
	public int queryCountByUsername(@Param("username") String username, @Param("permission") SysPermissionEntity sysPermission);
	 ...
	 * @return
	 */
	SysPermissionEntity getByPerms(@Param("perms") String perms);
