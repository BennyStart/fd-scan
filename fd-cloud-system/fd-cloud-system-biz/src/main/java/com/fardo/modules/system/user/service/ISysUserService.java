...
public interface ISysUserService extends IService<SysUserEntity> {
	 ...
	 * @param sysUserVo
	 */
    ResultVo<SysUserIdParamVo> saveUser(SysUserVo sysUserVo);

	/**
	 * 更新用户信息
	 * @param sysUserVo
	 */
    ResultVo<SysUserIdParamVo> updateUser(SysUserUpdateVo sysUserVo);
	...
	SysUserModel getUserModelByZfzh(String zfzh);

	List<SysUserSiteModel> loadUserListForUserSite();
