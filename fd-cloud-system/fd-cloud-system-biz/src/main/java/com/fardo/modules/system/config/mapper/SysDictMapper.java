...
import com.fardo.modules.system.base.model.DuplicateCheckVo;
...
public interface SysDictMapper extends BaseMapper<SysDictEntity> {
	 ...
	 * @param id
	 */
	@Select("delete from t_sys_dict where id = #{id}")
	 ...
	 * @return
	 */
	@Select("select * from t_sys_dict where del_flag = 1")
	 ...
	 * @param id
	 */
	@Update("update t_sys_dict set del_flag = #{flag,jdbcType=INTEGER} where id = #{id,jdbcType=VARCHAR}")
